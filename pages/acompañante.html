...
<html lang="en">
  ...
  <section>
    ...
    <div class="M-MiAcompañante">
    
      <div class="M-foto">
        <img src="/images/Acompañante.png" alt="woman vector" width="200">
      </div>
      <div class="M-TextoMiAcompañante">
        <p class="M-Graciela">¡Hola Juana! Mi nombre es Graciela, es un placer acompañarte en tu día a día</p> 
        <p class="M-TextoMini">En está seccion, vas a encontrar mis consejos, las actividades que me compartís, tus actividades completas con mi feedback, ¡entre muchas cosas mas!</p>
      </div>
      </div>


      <div class="M-CajasAcompañante">
    
    
        <div class="M-Cajita1">
          <div class="M-InfoCajita"><h3 class="act">Actividades</h3><p>¡Juana, felicitaciones por cumplir las metas propuestas!</p></div>
          <div class="M-BotonesA">
          <a href="#" class="M-BotonesCajita">Ver mas</a>
          </div>
        </div>
  
  
        <div class="M-Cajita2">
          <div class="M-InfoCajita"><h3 class="act">Relajación</h3><p>¡Seguí así! Cumpliste con éxito las técnicas de relajación</p></div>
        <div class="M-BotonesA">
        <a href="#" class="M-BotonesCajita">Ver mas</a>
        </div>
      </div>
        ...
        <div class="M-Cajita3">
          <div class="M-InfoCajita"><h3 class="act">Propuesta diaria</h3><p>¡Felicitaciones, cumpliste todas las actividades diarias</p></div>
          <div class="M-BotonesA">
          <a href="#" class="M-BotonesCajita">Ver mas</a>
          </div>
      </div>
