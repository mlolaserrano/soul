...
<html lang="en">
  <head>
    ...
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
    <link
      href="https://fonts.googleapis.com/css2?family=Coustard:wght@400;900&family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap"
      rel="stylesheet"
    />
...
<body class="bg2">
  ...
  <section class="pagina-login">
    <div class="contenedor-login">
        <div class="lado-izquierdo-login2">
            <!-- Imagen ya en el CSS -->
        </div>
        <div class="lado-derecho-login">
            <h1>Inicia sesión</h1>
            <h3 id="iniciar">Cada día un poquito más feliz</h3>
            <form action="" id="formulario">
                ...
                <p class="s-letra">¿Sos paciente? Ingresá <a href="/index.html" class="s-login-link">acá</a></p>
                <br>
            </form>
        </div>
    </div>
