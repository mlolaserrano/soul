...
class componenteAdm extends HTMLElement {
  connectedCallback() {
    ...
    <nav>
      ...
      <a href="../../pages/admin/(adm)home.html" class="enlace-home">
          <img src="../../images/Logo.png" alt="" class="logo">
      </a>
      <ul class="iconos">
          <li class="icon">
          ...
          <li class="icon">
           ...
           <ul class="submenu-list">
              <li><a href="../../pages/admin/(adm)calendario.html" class="bubbly-submenu">Calendario</a></li>
              <li><a href="../../pages/admin/(adm)actividades.html" class="bubbly-submenu">Actividades</a></li>
              <li><a href="../../pages/admin/(adm)acompañante.html" class="bubbly-submenu">Mi Acompañante</a></li>
              <li><a href="../../pages/admin/(adm)recompensa.html" class="bubbly-submenu">Recompensas</a></li>
          </ul>
      </div>
  </nav>
       `;
